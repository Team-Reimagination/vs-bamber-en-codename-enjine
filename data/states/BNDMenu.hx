...
var earth, cloudEmitter, windEmitter, constellation, constellationSound; //they all don't get assigned anything if the state was initialized beforehand
...
function skipIntro() {
    if (!initialized) {
        ...
        windEmitter.destroy(); earth.destroy(); cloudEmitter.destroy();
    }
}
